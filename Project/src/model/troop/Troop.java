...
public abstract class Troop implements Constructible, Attacker{
	...
	public Cost nextMoveInAttack(Map map )//overrides in healer //TODO implementing this method
	{
		Cost cost = null ;
		if( this.isDead )
			return null;
	...
	protected void findTargetInAttack( Map map ) {
	...
	protected Location BFS( Map map , Location startLocation , ArrayList<BuildingType> targetBuildingTypes )
	{
		int[] xMove = {-1, 0, 0, 1 };
		int[] yMove = {0, 1, -1, 0 };
