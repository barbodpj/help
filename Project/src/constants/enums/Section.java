...
public enum Section {
    ...
    public static void updateMenu() {
        Attack.menu = Attack.menu + "1. " + Attack.validCommands.get(5) + "\n";
        int i;
        for(i = 0; i < Attack.dynamicValidCommands.size(); i++) {
            Attack.menu = Attack.menu + (i + 2) + ". " + Attack.dynamicValidCommands.get(i) + "\n";
        }
        Attack.menu = Attack.menu + (i + 2) + ". " + Attack.validCommands.get(4);

        for(i = 0; i < AvailableBuildings.dynamicValidCommands.size(); i++) {
            Attack.menu = Attack.menu + (i + 1) + ". " + Attack.dynamicValidCommands.get(i) + "\n";
        }
        Attack.menu = Attack.menu + (i + 1) + ". Back";
